    ...
    def getRankedList(self, question):
        ...
        for i in range(self.numSelectedSentences):
            ...
            for sentence in sentences:
                ...
                # why these two similiarity calculated in different ways
                ques_sim = similarity.calculateSimilarity(sentence.tokens, question.tokens)
                self.logger.info(ques_sim)
